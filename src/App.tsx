		...
		<div className="container">
			...
			<div className="grid grid-cols-3 gap-8">
				...
				<ul className="space-y-1 text-left">
					...
					<li style={{ color: 'var(--color-surface-raised)' }}>surface-raised</li>
					<li style={{ color: 'var(--color-surface-overlay)' }}>surface-overlay</li>
					<li style={{ color: 'var(--color-border)' }}>border</li>
					<li style={{ color: 'var(--color-text)' }}>text</li>
					<li style={{ color: 'var(--color-text-muted)' }}>text-muted</li>
				</ul>
			</div>
		</div>
	);
